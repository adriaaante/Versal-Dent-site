...
**две** PNG (как у всех врачей):
- `assets/img/doctors/<slug>.png` — 480×600 (полная);
- `assets/img/doctors/<slug>-thumb.png` — 256×320 (миниатюра карточки,
  на неё ссылаются `doctors/index.html` и блок врачей на `index.html`).
