...
Slug-и врачей-«слотов» без отдельной страницы: `hachatryan` (Хачатрян
Карина, детский), `savchuk` (Савчук Григорий), `kendabaeva` (Кендабаева
Зухро, гигиенист), `kilasoniya` (Киласония Шорена, хирург-терапевт — фото
ждём). Их карточки в `doctors/index.html` и на главной — не `<a>`, без
отдельной страницы.
