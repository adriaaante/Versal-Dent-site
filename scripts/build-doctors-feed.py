...
SHOP = {
    ...
    'url': 'https://versal-dent.ru/',
    'picture': 'https://versal-dent.ru/assets/img/logo.png',
    'email': 'versal.dent@mail.ru',
}

CLINIC = {
    'name': 'Стоматология «Версаль»',
    'url': 'https://versal-dent.ru/',
    'picture': 'https://versal-dent.ru/assets/img/logo.png',
    'city': 'г. Реутов',
    ...
    'email': 'versal.dent@mail.ru',
    'phone': '+79651885888',
    'company_id': '107897418441',   # oid карточки на Яндекс.Картах
}
...
DOCTORS = [
    {'slug': 'drobkova', 'name': 'Дробкова Кристина Олеговна',
     ...
     'service': ('konsultaciya-ortodonta', 'Консультация ортодонта'),
     'price': 0,
     'check_price': ('ceny.html', 'Консультация ортодонта')},
    {'slug': 'rustamov', 'name': 'Рустамов Эмиль Дилгамович',
     ...
     'service': ('konsultaciya', 'Первичная консультация с осмотром и планом лечения'),
     'price': 1000,
    ...
    {'slug': 'kilasoniya', 'name': 'Киласония Шорена Гиулиевна',
     ...
     'price': 1000,
     'check_price': ('ceny.html', 'Первичная консультация с осмотром и планом лечения')},
    {'slug': 'savchuk', 'name': 'Савчук Григорий Олегович',
     'speciality': 'стоматолог-хирург',
     'description': 'Стоматолог-хирург, имплантолог, ортопед. Имплантация, удаление зубов, протезирование на имплантах.',
     'service': ('konsultaciya', 'Первичная консультация с осмотром и планом лечения'),
     'price': 1000,
     'check_price': ('ceny.html', 'Первичная консультация с осмотром и планом лечения')},
    {'slug': 'burnaceva', 'name': 'Бурнацева Диана Алановна',
     'speciality': 'стоматолог-терапевт',
     'description': 'Стоматолог-терапевт, ортопед. Лечение кариеса и корневых каналов, реставрации, коронки и виниры.',
     'service': ('konsultaciya', 'Первичная консультация с осмотром и планом лечения'),
     'price': 1000, 'photo': False, 'experience_years': 8,   # фото врача ещё нет
     'check_price': ('ceny.html', 'Первичная консультация с осмотром и планом лечения')},
    {'slug': 'hachatryan', 'name': 'Хачатрян Карина Вачагановна',
     ...
     'price': 1000,
     'check_price': ('ceny.html', 'Консультация детского стоматолога и план лечения')},
